...
$result = mysqli_query($con,"SELECT videos.name, videos.description, videos.user_id, videos.categories_id, videos.date_added, videos.url, users.username FROM videos INNER JOIN users ON videos.user_id=users.id WHERE videos.id='$id'");
